          ...
          <div class='product-details-tab' role="tabpanel">
            ...
            <ul class="nav nav-tabs" role="tablist" id='product-detail-tab'>
              <li role="presentation" class="active">
                <a href="#detail" aria-controls="home" role="tab" data-toggle="tab">Details</a>
              </li>
              <li role="presentation">
                <a href="#overview" aria-controls="profile" role="tab" data-toggle="tab">Overview</a>
              </li>
            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane" id="overview">Additional Information</div>
            </div>
