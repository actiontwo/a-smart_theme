  ...
  <div class="container_24 ">
    <div class="grid_6">
      <div class="widget widget-static-block menu">
        <div class="menu-title sub-title-header">Sửa chữa</div>
        <div class="menu-content">
          <div class="menu-wrapper wrapper-4_3959">
            <div class="em_nav menu-header-yellow">
              <ul class="vnav ">
                <li class="menu-item-link menu-item-depth-0  menu-item-parent"><a href="#" class="arrow"><span>&gt;</span></a>
                  <a href=""><span>Sửa IPhone</span></a>
                  <ul class="menu-container">
                    <li class="menu-item-hbox menu-item-depth-1 grid_6 menu-item-parent" style="">
                      <ul class="menu-container menu-item-yellow">
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Thay màn hình mặt kính iPhone</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa iPhone 3G/3Gs</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa iPhone 4G/4S</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa iPhone 5/5S</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa iPhone 6/6 Plus</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Khác</a>
                        </li>
                ...
                <li class="menu-item-link menu-item-depth-0  menu-item-parent"><a href="#" class="arrow"><span>&gt;</span></a>
                  <a href="./category.html"><span>Sửa Samsung</span></a>
                  <ul class="menu-container">
                    <li class="menu-item-hbox menu-item-depth-1 grid_6 menu-item-parent" style="">
                      <ul class="menu-container menu-item-yellow">
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Thay màn hình mặt kính Samsung</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa Samsung S1, S2, S3, S4, S5</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa Samsung Note 1, 2, 3, 4</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa Samsung Mega</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa máy tính bảng Samsung</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa Samsung khác</a>
                        </li>
                      </ul>
                    </li>
                  </ul>
                ...
                <li class="menu-item-link menu-item-depth-0  menu-item-parent"><a href="#" class="arrow"><span>&gt;</span></a>
                  <a href="./category.html"><span>Sửa Sony</span></a>
                  <ul class="menu-container">
                    <li class="menu-item-hbox menu-item-depth-1 grid_6 menu-item-parent" style="">
                      <ul class="menu-container">
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Thay màn hình mặt kính Sony</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa Sony Z</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa Sony Z1</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa Sony Z2</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa Sony Z3</a>
                        </li>
                        <li class="menu-item-text menu-item-depth-2">
                          <a href="">Sửa Sony khác</a>
                        </li>
                      </ul>
                    </li>
                  </ul>
                ...
                <li class="menu-item-link menu-item-depth-0">
                  <a href="./category.html"><span>Sửa LG</span></a>
                </li>
                <li class="menu-item-link menu-item-depth-0">
                  <a href="./category.html"><span>Sửa Sky</span></a>
                </li>
                <li class="menu-item-link menu-item-depth-0">
                  <a href="./category.html"><span>Sửa Asus</span></a>
                </li>
                <li class="menu-item-link menu-item-depth-0">
                  <a href="./blog.html"><span>Sửa HTC</span></a>
                </li>
                <li class="menu-item-link menu-item-depth-0">
                  <a href="./category.html"><span>Sửa Oppo</span></a>
                </li>
                <li class="menu-item-link menu-item-depth-0">
                  <a href="./category.html"><span>Sửa Nokia</span></a>
                </li>
                <li class="menu-item-link menu-item-depth-0">
                  <a href="./category.html"><span>Sửa Lenovo</span></a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="widget widget-static-block menu">
        <div class="menu-title sub-title-header">Phụ kiện</div>
        <div class="menu-content">
          <div class="menu-wrapper wrapper-4_3959">
            <div class="em_nav menu-header-yellow">
              <ul class="vnav ">
                <li class="menu-item-link menu-item-depth-0">
                  <a href=""><span>Dock sạc pin</span></a>
                </li>
                <li class="menu-item-link menu-item-depth-0">
                  <a href=""><span>Thẻ nhớ</span></a>
                </li>
                <li class="menu-item-link menu-item-depth-0">
                  <a href=""><span>Bao da - Ốp lưng</span></a>
                </li>
                <li class="menu-item-link menu-item-depth-0">
                  <a href=""><span>Nắp pin, vỏ</span></a>
                </li>
                <li class="menu-item-link menu-item-depth-0">
                  <a href=""><span>Thay khung viền</span></a>
                </li>
                <li class="menu-item-link menu-item-depth-0">
                  <a href=""><span>Sạc dự phòng</span></a>
                </li>
              </ul>
            </div>
          </div>
